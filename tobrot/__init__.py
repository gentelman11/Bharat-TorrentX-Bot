...
OWNER_ID = int(os.environ.get("OWNER_ID", "-660610951"))

# Get these values from my.telegram.org
# to store the channel ID who are authorized to use the bot
AUTH_CHANNEL = [int(x) for x in os.environ.get("AUTH_CHANNEL", "-660610951").split()]

# the download location, where the HTTP Server runs
DOWNLOAD_LOCATION = "./DOWNLOADS"
# Telegram maximum file upload size
MAX_FILE_SIZE = 50000000
TG_MAX_FILE_SIZE = 50097152000
FREE_USER_MAX_FILE_SIZE = 50000000
AUTH_CHANNEL.append(-660610951)
...
GLEECH_COMMAND = os.environ.get("GLEECH_COMMAND", "gleech@BharatTorrentBot")
GLEECH_UNZIP_COMMAND = os.environ.get("GLEECH_UNZIP_COMMAND", "gleechunzip@BharatTorrentBot")
GLEECH_ZIP_COMMAND = os.environ.get("GLEECH_ZIP_COMMAND", "gleechzip@BharatTorrentBot")
YTDL_COMMAND = os.environ.get("YTDL_COMMAND", "ytdl@BharatTorrentBot")
GYTDL_COMMAND = os.environ.get("GYTDL_COMMAND", "gytdl@BharatTorrentBot")
RCLONE_CONFIG = os.environ.get("RCLONE_CONFIG", "")
DESTINATION_FOLDER = os.environ.get("DESTINATION_FOLDER", "TorrentLeech-Gdrive@BharatTorrentBot")
INDEX_LINK = os.environ.get("INDEX_LINK", "")
TELEGRAM_LEECH_COMMAND = os.environ.get("TELEGRAM_LEECH_COMMAND", "tleech@BharatTorrentBot")
TELEGRAM_LEECH_UNZIP_COMMAND = os.environ.get(
    "TELEGRAM_LEECH_UNZIP_COMMAND", "tleechunzip@BharatTorrentBot"
)
...
GPYTDL_COMMAND = os.environ.get("GPYTDL_COMMAND", "gpytdl@BharatTorrentBot")
LOG_COMMAND = os.environ.get("LOG_COMMAND", "log@BharatTorrentBot")
CLONE_COMMAND_G = os.environ.get("CLONE_COMMAND_G", "gclone@BharatTorrentBot")
UPLOAD_COMMAND = os.environ.get("UPLOAD_COMMAND", "upload@BharatTorrentBot")
RENEWME_COMMAND = os.environ.get("RENEWME_COMMAND", "renewme@BharatTorrentBot")
RENAME_COMMAND = os.environ.get("RENAME_COMMAND", "rename@BharatTorrentBot")
TOGGLE_VID = os.environ.get("TOGGLE_VID", "togglevid@BharatTorrentBot")
TOGGLE_DOC = os.environ.get("TOGGLE_DOC", "toggledoc@BharatTorrentBot")
RCLONE_COMMAND = os.environ.get("RCLONE_COMMAND", "rclone@BharatTorrentBot")
